...
while True:
    ...
    if interrupt & 0xFF == ord('1'):
        cv2.imwrite(directory+'I/'+str(count['1'])+'.jpg',frame)
    if interrupt & 0xFF == ord('2'):
        cv2.imwrite(directory+'sign/'+str(count['2'])+'.jpg',frame)
    if interrupt & 0xFF == ord('3'):
        cv2.imwrite(directory+'Indian/'+str(count['3'])+'.jpg',frame)
    if interrupt & 0xFF == ord('4'):
        cv2.imwrite(directory+'Language/'+str(count['4'])+'.jpg',frame)    
